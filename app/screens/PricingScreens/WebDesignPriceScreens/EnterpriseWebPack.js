  ...
  return (
    <ImageBackground
      ...
      <View  style={[pricingStyles.boxcontainer,pricingStyles.shadowProp]}>
        <Text style={pricingStyles.heading}>Enterprise Package</Text>
        <View style={pricingStyles.line}/>
        <Text style={pricingStyles.price}>&#x20b9; 25,000  / Annual</Text>
...
export default EnterpriseWebPack