...
const ProfessionalWebPack = () => {
  return (
    ...
    <View  style={[pricingStyles.boxcontainer,pricingStyles.shadowProp]}>
      <Text style={pricingStyles.heading}> Professional Package</Text>
      <View style={pricingStyles.line}/>
      <Text style={pricingStyles.price}>&#x20b9; 16,500  / Annual</Text>
...
export default ProfessionalWebPack