    ...
    <>
      <NavigationContainer>
          ...
          > 
            ...
            <Drawer.Screen name='Hire A Freelancer' component={HireDeveloper} options={{ drawerLabel: 'Hire A Freelancer', title: false, drawerIcon: ({color}) => ( <Icon name='customerservice' size={20} color={color} /> ), drawerItemStyle: { height: 0, display: 'none' } }} />
